...
- Skip keeps the question open or deferred.
...
The patient can reach profile home when the queue contains no blocking required questions. Skipped or unknown required categories remain visible as missing/unconfirmed flags.
